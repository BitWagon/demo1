    ...
    <>
      ...
      <main>
        <ServiceHero
          ...
          description="Explore business water and related services designed around your organisation's requirements."
        />
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-14 items-center">
              ...
              <Reveal direction="left" delay={0.15}>
                <div className="rounded-3xl bg-slate-900 p-10 min-h-[420px] flex flex-col justify-center hover:-translate-y-2 transition-transform duration-500">
                  ...
                  <p className="mt-4 text-slate-300 leading-7">
                    Explore options that can help your organisation manage its
